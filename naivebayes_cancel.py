#Using Naive Bayes,predict if the flight is going to be cancelled, based on data inputs.
...
#connect to mysql database and retrieve cleaned data set (naivebayes2) for running model
