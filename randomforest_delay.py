#Using Random Forest,predict if the flight is going to be delayed (more than 15 mins) or not, based on data inputs.
...
#connect to mysql database and retrieve cleaned data set (randomforest1) for running model
